...
var DarkTile = function DarkTile(_ref) {
  ...
  var backgroundColor = '#18202b';

  if (cellNum >= 2048) {
    backgroundColor = 'black';
  } else if (cellNum >= 1024) {
    backgroundColor = '';
  } else if (cellNum >= 512) {} else if (cellNum >= 256) {} else if (cellNum >= 128) {} else if (cellNum >= 64) {} else if (cellNum >= 32) {} else if (cellNum >= 16) {
...
//# sourceMappingURL=index.js.07e90c24781a32ef15d9.hot-update.js.map